...
def get_droneid_movements_based_on_id_of_drone_and_flight():
    try:
        ...
        droneid_movements = DroneIDMovement.query.filter_by(flight_id=flight_id, drone_id=drone_id).all()
...
def get_remoteid_movements_based_on_id_of_drone_and_flight():
    try:
        ...
        remoteid_movements = RemoteIDMovement.query.filter_by(flight_id=flight_id, remote_id=drone_id).all()
...
def get_droneid_flights_based_on_id_of_drone():
    try:
        ...
        droneid_flights = DroneIDFlight.query.filter_by(drone_id=drone_id).all()
        
        flights_data = []
        for flight in droneid_flights:
            first_entry = (
                DroneIDMovement.query
                .filter_by(flight_id=flight.id, drone_id=drone_id)
...
def get_remoteid_flights_based_on_id_of_drone():
    try:
        ...
        remoteid_flights = RemoteIDFlight.query.filter_by(remote_id=drone_id).all()
